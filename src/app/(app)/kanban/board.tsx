          ...
          >
            ...
            {items.map((t) => (
              <div
                ...
                className="cursor-grab rounded-lg border border-zinc-200 bg-white shadow-sm bg-white p-3 shadow-sm active:cursor-grabbing dark:border-zinc-700 dark:bg-[#2a2f39]"
              >
                <p
                  className={`text-sm ${
                    t.status === "done"
