  ...
  return (
    <main className="mx-auto flex max-w-5xl flex-col gap-8 p-8">
          ...
          {BUILTIN_APPS.map((app) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">{app.description}</p>
      ...
      <section>
        ...
        >
          <span className="text-sm text-zinc-500 dark:text-zinc-400">Kada</span>
          <select
            name="trigger_type"
          ...
          <span className="text-sm text-zinc-500 dark:text-zinc-400">onda</span>
          <select
            name="action_type"
            className="rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50"
          >
