              ...
              <ul className="flex flex-col gap-1">
                {g.hits.map((h, i) => (
                  <li key={i}>
                    <Link
                      href={h.href}
                      className="block rounded-lg border border-zinc-200 bg-white shadow-sm px-3 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-800 dark:bg-[#20242c] dark:hover:bg-zinc-900"
                    >
